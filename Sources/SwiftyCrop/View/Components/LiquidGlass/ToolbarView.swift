  ...
  var body: some View {
      ...
      GlassEffectContainer {
        HStack {
          ...
          #if !os(visionOS)
            .glassEffect(
              .regular.tint(configuration.colors.cancelButtonBackground)
                .interactive()
            )
          #endif
          ...
          if configuration.rotateImageWithButtons {
            ...
            .padding()
              ...
              .glassEffect(
                .regular.tint(
                  configuration.colors.resetRotationButtonBackground
                ).interactive()
              )
            #endif
            .opacity(
              viewModel.angle.degrees.truncatingRemainder(dividingBy: 360) == 0
                ? 0.7 : 1
            )
            .disabled(
              viewModel.angle.degrees.truncatingRemainder(dividingBy: 360) == 0
            ...
            #if !os(visionOS)
              .glassEffect(
                .regular.tint(configuration.colors.rotateButtonBackground)
                  .interactive()
              )
            #endif
          }
          ...
          #if !os(visionOS)
            .glassEffect(
              .regular.tint(configuration.colors.saveButtonBackground)
                .interactive()
            )
          #endif
        }
      ...
      VStack {
        Text(
          "iOS 26 is not supported. Adjust the simulator or your Xcode version."
        )
      }
      .border(.red)
    #endif
